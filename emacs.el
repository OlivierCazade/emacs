...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yaml-mode which-key use-package smex smartparens py-autopep8 projectile markdown-mode magit jedi helm flycheck exec-path-from-shell elpy dockerfile-mode diff-hl counsel ansible ample-theme aggressive-indent))))
(custom-set-faces
