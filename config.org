...
(setq org-capture-templates
 '(("i" "Inbox" entry (file "~/org/inbox.org")
   ...
   ("a" "Work arrival" entry (file+datetree "~/org/journal.org")
        "* Onrewind arrival %U" :immediate-finish t  :clock-in t :clock-keep t)
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq oc/keep-clock-running nil)

  (defun oc/arrival-hook ()
    ;; (setq oc/keep-clock-running org-capture-last-stored)
    ;; (org-with-point-at oc/keep-clock-running
    ;;   (org-clock-in))
  )
