...
#+begin_src emacs-lisp
  (use-package exec-path-from-shell
    :config
    (setq exec-path-from-shell-variables '("PATH" "GOPATH" "SHELL" "LC_CTYPE" "LC_ALL" "LANG" "PYENV_ROOT" "NODE_PATH" "AWS_PROFILE" "CLAUDE_CODE_USE_VERTEX" "CLOUD_ML_REGION" "ANTHROPIC_VERTEX_PROJECT_ID"))
...
Bindings in vterm :
C-c C-t : enable/disable vterm copy mode
...
(setq org-capture-templates
 '(("i" "Inbox" entry (file "~/org/inbox.org")
   ...
   ("I" "Work arrival" entry (file+datetree "~/org/journal.org")
        "* Work arrival %u" :immediate-finish t)
   ("O" "Work departure" entry (file+datetree "~/org/journal.org")
        "* Work departure %u" :immediate-finish t)
  ))
#+end_src
